    ...
    <header className="fixed top-0 z-50 w-full border-b border-white/5 bg-[#050505]/80 backdrop-blur-xl">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        <Link
          ...
          aria-label={t('detailing.nav.home_label')}
        >
          <div
            className="size-9 bg-blue-500 rounded-lg flex items-center justify-center rotate-3 group-hover:rotate-0 transition-transform"
            aria-hidden="true"
          >
            <span className="material-symbols-outlined text-white text-xl">directions_car</span>
          </div>
          <h2 className="text-xl font-bold tracking-tight text-white">
            Detailing Hub <span className="text-blue-500">3D</span>
          </h2>
        </Link>
        <nav className="hidden md:flex items-center gap-10" aria-label="Project navigation">
          <a
            ...
            href="#process"
          >
            {t('detailing.nav.process')}
          </a>
          <a
            className="text-sm font-medium text-white/60 hover:text-white transition-colors"
            href="#technical"
          >
            {t('detailing.nav.technical')}
          </a>
          <a
            className="text-sm font-medium text-white/60 hover:text-white transition-colors"
            href="#impact"
          >
            {t('detailing.nav.impact')}
          </a>
