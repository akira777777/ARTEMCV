    ...
    <footer id="footer" className="py-20 bg-black border-t border-white/10 pb-40 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-16 text-sm tracking-widest font-bold">
          <a href="mailto:fear75412@gmail.com" className="relative hover:text-neutral-400 transition-colors after:absolute after:left-0 after:-bottom-2 after:h-px after:w-0 after:bg-white/60 after:transition-all after:duration-300 hover:after:w-full">FEAR75412@GMAIL.COM</a>
          <a href="https://t.me/younghustle45" target="_blank" rel="noopener noreferrer" className="relative hover:text-neutral-400 transition-colors after:absolute after:left-0 after:-bottom-2 after:h-px after:w-0 after:bg-white/60 after:transition-all after:duration-300 hover:after:w-full">TELEGRAM</a>
          <a href="https://github.com/akira777777" target="_blank" rel="noopener noreferrer" className="relative hover:text-neutral-400 transition-colors after:absolute after:left-0 after:-bottom-2 after:h-px after:w-0 after:bg-white/60 after:transition-all after:duration-300 hover:after:w-full">GITHUB</a>
        ...
        <p className="mt-20 text-neutral-600 text-xs">
          © {new Date().getFullYear()} JULES ENGINEER. ALL RIGHTS RESERVED.
        </p>
      </div>
    </footer>
  );
