...
export const CodeIcon = (props: Omit<IconProps, 'name'>) => (
  <Icon name="code-brackets" {...props} />
);
...
export const LightningIcon = (props: Omit<IconProps, 'name'>) => (
...
export const CodeBlockIcon = (props: Omit<IconProps, 'name'>) => (
  <Icon name="code-block" {...props} />
);
...
export const ProcessingIcon = (props: Omit<IconProps, 'name'>) => (
  <Icon name="processing" {...props} />
);
