...
const TestAccessibilityComponent: React.FC = () => {
  ...
  return (
    <div>
      ...
      <button data-testid="increase-font" onClick={() => setFontSize(fontSize + 10)}>
        Increase Font
      </button>
      <button data-testid="toggle-contrast" onClick={() => setHighContrast(!highContrast)}>
        Toggle Contrast
      </button>
      <button data-testid="toggle-motion" onClick={() => setReducedMotion(!reducedMotion)}>
        Toggle Motion
      </button>
    </div>
  );
