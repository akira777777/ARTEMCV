...
const translations: Record<Lang, Dict> = {
  ...
  ru: {
    ...
    'cta.title.temp': 'Давайте создадим что-то классное вместе',
    'cta.subtitle.temp': 'Готовы воплотить ваше видение в жизнь? Я специализируюсь на создании высокопроизводительных интерактивных веб-приложений, адаптированных под ваши потребности.',
    'cta.button.temp': 'Начать сотрудничество',
    'cta.secondary.temp': 'Смотреть GitHub',

    'project.1.title.temp': 'Barber Shop',
    'project.1.desc.temp': 'AI-диспетчер барбершопа: онлайн-запись, анти-овербукинг, CRM клиентов и платежная аналитика. Оптимизирован под многокресельные салоны.',
    'project.2.title.temp': 'Dental Clinic Vakalova',
    'project.2.desc.temp': 'Лендинг и запись к врачу: каталог услуг, интерактивные планы лечения, отзывы пациентов. Уделено внимание доступности и скорости загрузки.',
    'project.3.title.temp': 'Game Marketplace',
    'project.3.desc.temp': 'Современный маркетплейс игр с каталогом, корзиной покупок, системой фильтрации и адаптивным интерфейсом. Реализованы анимации и плавные переходы.',
